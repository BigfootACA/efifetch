...
extern const struct efi_guid_item efi_guid_table[];
typedef struct arm_cpuid_item{
	uint8_t implementer;
	uint16_t part;
	const char*name;
}arm_cpuid_item;
extern const arm_cpuid_item arm_cpuid_items[];
#define DECL_CPUID_ARM_START const arm_cpuid_item arm_cpuid_items[]={
...
extern const gpu_item gpu_db[];
#define GPU_DB_START const gpu_item gpu_db[]={
